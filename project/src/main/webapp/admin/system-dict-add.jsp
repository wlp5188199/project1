			...
			<form class="form form-horizontal" id="form-dict-add">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" placeholder="名称" id="dict_name" name="dict_name">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>表名：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" autocomplete="off" placeholder="表名" id="dict_tabname" name="dict_tabname">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>字段名：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" autocomplete="off" placeholder="字段名" id="dict_colname" name="dict_colname">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">option：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" placeholder="option" id="dict_option" name="dict_option">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">文本值：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" placeholder="文本值" name="dict_text" id="dict_text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-3">排序：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" placeholder="排序" name="dict_sort" id="dict_sort">
					</div>
				</div>
				<div class="row cl">
